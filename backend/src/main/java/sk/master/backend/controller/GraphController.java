...
import sk.master.backend.persistence.dto.GraphResponseDto;
...
public class GraphController {
    ...
    public ResponseEntity<GraphResponseDto> generateGraphFromFile(@RequestParam("file") MultipartFile file) throws Exception {
        ...
        return ResponseEntity.ok(GraphResponseDto.fromRoadGraph(data));
    }

    @GetMapping("/load")
    public ResponseEntity<GraphResponseDto> loadGraphFromDatabase(@RequestParam("graphId") Long graphId) {
